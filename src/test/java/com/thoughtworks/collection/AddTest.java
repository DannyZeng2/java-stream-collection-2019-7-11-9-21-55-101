...
public class AddTest {
    ...
    @Test
    public void should_get_sum_of_evens() {  //预计：1min 实际：3min
    ...
    @Test
    public void should_get_sum_of_odds() { //预计：1min 实际：1min
    ...
    @Test
    public void should_get_triple_and_add_two() {  //预计：3min 实际：3min
        //求数组中每个元素的3倍加2的和
    ...
    @Test
    public void should_get_triple_of_odd_and_add_two() { //预计：1min 实际：1min
...
//    }
    ...
    @Test
    public void should_return_average_of_even() {  //预计：1min 实际：4min
        //求数组中所有偶数的平均数
        Integer[] array = new Integer[]{1, 2, 3, 4, 5};
        List<Integer> arrayList = Arrays.asList(array);
...
//    }
    ...
    @Test
    public void should_return_unrepeated_elements_from_evens() {  //预计：1min 实际：1min
